      ...
      <div className="loginContainer w-2/6 h-4/6 bg-white flex flex-col items-center justify-center">
        ...
        <div className="inputsContainer mt-5">
          ...
          <div className='forgotContainer flex items-center flex-col mt-4'>
            <h1 className='text-xs text-orange-400 underline'>Esqueceu sua senha?</h1>
            <h1 className='text-xs mt-4'>Ainda nao possui conta? <span className='text-xs text-orange-400 underline'>Cadastre-se agora</span></h1>
          </div>
        </div>
      </div>
      <footer>
        <div>
          <div className='footerDivider fixed bottom-0 left-0 right-0 border border-slate-200 h-16 items-center flex justify-evenly'>
            ...
            <div className='texto2 flex'>
              <Image className="" src="/images/unifor.png" width={20} height={20} alt="logo"/>
